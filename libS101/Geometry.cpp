...
//	p = GetOffsetPointOnLine(tmpP1, tmpP2, symbolWidth * symbolCount); // Composite line�� ��� �׸� ���� ��ġ
//
//	// p�� Line���� �ִ� ���(x������ �˻��Ѵ�)
...
//	}
//
//	double centerDistance = GetDistanceOfPolyline(_p, _count) / 2; // ���������� ���������� ���������� �߰����� ������ �Ÿ�
//
//	if (centerDistance == 0)
//	{
//		return NULL;
...
//	{
//		accumulatedDistance += GetDistance(_p[i], _p[i + 1]);      // ���������� �̵��ϸ鼭 �����Ÿ��� ����
//
//		if (accumulatedDistance >= centerDistance)				   // �����Ÿ��� �߰��Ÿ����� ũ�ٸ� �߰����� �������̴�.
//		{
//			*returnValue = GetOffsetPointOnLine(_p[i + 1], _p[i], accumulatedDistance - centerDistance); // ������ �Ÿ���ŭ ���ư���.
//			break;
//		}
//	}
//
